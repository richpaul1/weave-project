 ...
 * 
 * PURPOSE: Render markdown content with clean HTML
 * MediaRestorationService now handles all DocVideo → HTML conversion
 * 
 * FEATURES:
 * - Syntax highlighting for code blocks
 * - Table rendering with proper styling
 * - Image and link handling
 * - Clean HTML rendering (no DocVideo processing)
 */
